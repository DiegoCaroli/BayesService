...
import com.diego.BayesANDJess.Wrapper.InfAlgorithm;
import com.diego.BayesANDJess.Wrapper.JayesException;
import com.diego.BayesANDJess.Wrapper.NetLoader;
import com.diego.BayesANDJess.Wrapper.Wrapper;

public class BayesNet {
	//public static String netPath = "/Users/lucagrazioli/Documents/workspace/BayesANDJess/Dati_bayesian_net_agent.csv";
	...
	public BayesNet(String netPath){
		NetLoader nl = new NetLoader();
		nl.buildNet(netPath);
		this.wrapper = nl.getNet();
